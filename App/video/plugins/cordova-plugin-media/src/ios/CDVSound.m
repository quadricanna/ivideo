    ...
    if ((audioFile != nil) && (audioFile.resourceURL != nil)) {
        ...
        if (!bError) {
            ...
            if ([self hasAudioSession]) {
                ...
                [self.avSession setCategory:AVAudioSessionCategoryPlayback withOptions:(AVAudioSessionCategoryOptionAllowBluetooth,AVAudioSessionCategoryOptionAllowAirPlay) error:&err];
