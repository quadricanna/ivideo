...
exports.SUPPORTED_PLATFORMS = ['android', 'ios'];
...
async function runNativeRun({ config, log, shell }, args, options = {}) {
    ...
    const stream = connect ? logger_1.createPrefixedWriteStream(log, color_1.weak(`[native-run]`)) : undefined;
    try {
...
async function checkNativeRun({ config }) {
    try {
        await utils_subprocess_1.which('native-run');
    }
    catch (e) {
        if (e.code === 'ENOENT') {
